...
public class LendController {
    ...
    public String bookLendDo(HttpServletRequest request,RedirectAttributes redirectAttributes,int readerId){
        ...
        if (lendsucc){
            redirectAttributes.addFlashAttribute("succ", "도서 대출 성공!");
    ...
    public String bookReturn(HttpServletRequest request,RedirectAttributes redirectAttributes){
        ...
        if (retSucc){
            redirectAttributes.addFlashAttribute("succ", "책이 성공적으로 반납되었습니다!");
            return "redirect:/allbooks.html";
        }
        else {
            redirectAttributes.addFlashAttribute("error", "도서 반납 실패！");
            return "redirect:/allbooks.html";
        }
    }
