                ...
                <div class="input-group">
                   <input type="text" placeholder="책 이름 입력" class="form-control" id="search" name="searchWord" class="form-control">
                    <span class="input-group-btn">
                                    ...
                                    <input type="button" value="초기화" class="btn btn-default" onclick="location.href='/reader_querybook.html'">
                    </span>
                </div>
            </form>
            <script>
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${books}" var="book">
                    <tr>
                        ...
                        <td><a href="readerbookdetail.html?bookId=<c:out value="${book.bookId}"></c:out>"><button type="button" class="btn btn-success btn-xs">정보보기</button></a></td>
                    </tr>
                </c:forEach>
                </tbody>
            </table>
